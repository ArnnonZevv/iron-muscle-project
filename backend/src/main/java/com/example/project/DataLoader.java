...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        c1.setTitle("Morning Yoga"); c1.setSchedule("Mon 06:00-07:00"); c1.setCapacity(20); c1.setTrainer(t1);
        classRepo.save(c1);

        GymClass c2 = new GymClass();
        c2.setTitle("HIIT Blast"); c2.setSchedule("Tue 18:00-19:00"); c2.setCapacity(18); c2.setTrainer(t2);
        classRepo.save(c2);
    }
}
